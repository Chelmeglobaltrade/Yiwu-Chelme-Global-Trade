...
const extraFlat = number(config.lcl.smallCargoExtraFlatUsd);
const smallCargo = billableCbm > 0 && billableCbm < threshold;
const baseFreight = moneyRound(billableCbm * baseRate);
const smallCargoExtra = moneyRound(smallCargo ? extraFlat : 0);
...
baseFreight,
smallCargo,
smallCargoExtraFlat: smallCargo ? extraFlat : 0,
smallCargoExtra,
